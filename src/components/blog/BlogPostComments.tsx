  ...
  const [comments, setComments] = useState<Comment[]>([
    {
      ...
      author: {
        name: 'Sarah Johnson',
        avatar:
          'https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=professional%20headshot%20of%20a%20young%20woman%20software%20developer%2C%20friendly%20smile%2C%20modern%20office%20background&image_size=square',
      },
      content:
    ...
    },
    {
      ...
      author: {
        name: 'Mike Chen',
        avatar:
          'https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=professional%20headshot%20of%20a%20young%20asian%20male%20software%20developer%2C%20glasses%2C%20modern%20tech%20background&image_size=square',
      },
      content:
    ...
    },
    {
      ...
      author: {
        ...
        avatar:
          'https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=professional%20headshot%20of%20a%20young%20latina%20female%20software%20developer%2C%20confident%20smile%2C%20modern%20office%20background&image_size=square',
      },
      content:
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  disabled={
                    !replyContent.trim() || (!isLoggedIn && !guestName.trim())
                  }
                >
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              disabled={
                !newComment.trim() || (!isLoggedIn && !guestName.trim())
              }
            >
              <Send className="h-4 w-4 mr-2" />
              Post Comment
