...
export const SITE_CONFIG = {
  ...
  author: {
    ...
    social: {
      twitter: "https://twitter.com/aramtutorials",
      github: "https://github.com/aramtutorials",
      linkedin: "https://linkedin.com/in/aramtutorials",
...
export const SEO_DEFAULTS = {
  ...
  DEFAULT_DESCRIPTION: 'Learn technology through clear, practical tutorials. From Mac and Windows to Android and VS Code - we make tech simple, one tutorial at a time.',
  DEFAULT_KEYWORDS: ['tutorials', 'tech', 'mac', 'windows', 'android', 'vscode', 'programming', 'technology'],
...
export const MOCK_BLOG_POSTS = [
  ...
  },
  {
    ...
    seoDescription: 'Learn to build scalable REST APIs with Node.js and Express.',
